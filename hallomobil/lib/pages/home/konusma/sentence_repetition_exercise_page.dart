...
class SentenceRepetitionExercisePage extends StatefulWidget {
  final String selectedLanguage;
  final String selectedLevel;

  const SentenceRepetitionExercisePage({
    super.key,
  ...
  @override
  State<SentenceRepetitionExercisePage> createState() =>
      _SentenceRepetitionExercisePageState();
}

class _SentenceRepetitionExercisePageState
    extends State<SentenceRepetitionExercisePage>
  ...
  bool _isCorrect = false; // Tracks if sentence is correctly pronounced
  ...
  Future<void> _fetchExercises() async {
    try {
      final querySnapshot = await FirebaseFirestore.instance
          .collection('speaking_sentence_repetition')
        ...
        onResult: (result) {
          setState(() {
            ...
            if (_exercises.isNotEmpty) {
              String expectedSentence = _exercises[_currentExerciseIndex]
                      ['sentence']
                  .toString()
                  .toLowerCase();
              _isCorrect = _recognizedText
                  .toLowerCase()
                  .contains(expectedSentence.split(' ').first.toLowerCase());
              _feedbackMessage =
                  _isCorrect ? 'Doğru!' : 'Yanlış, tekrar deneyin!';
            } else {
              _feedbackMessage = 'Cümle bulunamadı!';
            }
  ...
  void _markAsCorrect() {
    setState(() {
      ...
      _recognizedText =
          _exercises[_currentExerciseIndex]['sentence'].toString();
    });
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'Cümle: ${_exercises[_currentExerciseIndex]['sentence']}',
                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'Türkçe: ${_exercises[_currentExerciseIndex]['sentenceTurkish']}',
                                          style: TextStyle(
                                            fontSize: 16,
                                            color: ColorConstants.TEXT_COLOR
                                                .withOpacity(0.7),
