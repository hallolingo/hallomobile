...
class LevelSelectionPage extends StatefulWidget {
  ...
  const LevelSelectionPage({super.key, required this.selectedLanguage});
...
class _LevelSelectionPageState extends State<LevelSelectionPage>
  ...
  void _navigateToFillBlank(String selectedLevel) {
    Navigator.pushNamed(
      context,
      AppRouter.fillBlank,
      arguments: {
    ...
    return AnimatedBuilder(
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: InkWell(
            borderRadius: BorderRadius.circular(20),
            onTap: () => _navigateToFillBlank(levelData['level']),
            child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              'Boşluk Doldurma - ${widget.selectedLanguage}',
                              style: TextStyle(
                                fontSize: 16,
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Expanded(
                            child: Text(
                              'Seviyenize uygun soruları çözerek dinleme becerinizi geliştirin',
                              style: TextStyle(
                                fontSize: 14,
                                color: ColorConstants.TEXT_COLOR,
